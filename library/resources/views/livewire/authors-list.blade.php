    ...
    <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200">
        <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead class="bg-gray-900 text-white  tracking-wide text-sm font-semibold text-center">
                <tr>
                    <th class="px-4 py-4 min-h-[2rem] w-[15%]">
                        <button wire:click="sortBy('name')"
                            class="flex items-center justify-center w-full hover:bg-gray-700 px-2 transition-colors duration-200">
                            <span>Name</span>
                    ...
                    <th class="px-4 py-4 min-h-[2rem] w-[20%]">Photo</th>
                </tr>
            </thead>
            <tbody>

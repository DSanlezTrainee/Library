            ...
            <table class="w-full border-2 border-gray-700 rounded-lg font-sans">
                ...
                <tbody class="bg-white text-gray-700 text-sm text-center">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-4 py-2 max-w-lg ">
                            <div x-data="{ open: false }">
                                <!-- Description preview -->
                                <p :class="open ? '' : 'overflow-hidden text-ellipsis whitespace-normal '"
                                    style="display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; background-color;">

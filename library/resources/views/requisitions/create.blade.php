        ...
        <div class="bg-white shadow-lg rounded-lg w-full max-w-xl">
            ...
            <div class="px-6 py-3">
                <form method="POST" action="{{ route('requisitions.store') }}" enctype="multipart/form-data">
                    ...
                    {{-- If admin can create for other users, show a user select; otherwise hidden user is used in controller --}}
                    ...
                    <div class="mb-4">
                        <label for="citizen_photo" class="block text-sm font-medium text-gray-700 mb-1">Citizen Photo</label>
                        <input type="file"
                               id="citizen_photo"
                               name="citizen_photo"
                               accept="image/*"
                        ...
                        <p class="text-gray-500 text-xs mt-1">Photo taken at the moment of request (jpg, png). Max 2MB.</p>
                    </div>

                    <div class="flex justify-end space-x-4 mt-6">
                        <a href="{{ route('requisitions.index') }}" class="px-6 py-2 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            Cancel
                        </a>
                        <button type="submit" class="px-6 py-2 border border-gray-300 text-black rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            Create Requisition
                        </button>
                    </div>
                </form>
